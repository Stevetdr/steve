...
void loop();
void LedBlink13();
void Suona_Led_Rosso(void);
void Suona_Led_Verde(void);
#line 1 "src/luce_allarme.ino"
...
int ValFotoR = 0 ;           // vaolore letto sul pin della fotoresistenza da 0 a 1024 (e' un intero)
...
//  (luce spenta) se e'=255 il PWM e' a 100 (accesa), se e'=128 e' al 50%. Vedi sotto!
    ...
    ValFotoR = int(analogRead(FotoR) / 4 );    // lettura del valore della fotoresistenza sul pin da 0 a 1024
